...
> Final destination of this plan file: `plans/mcp_sandbox.md` in the project. This copy
> lives in `.claude/plans/` while plan mode is active. After ExitPlanMode, copy
> the contents to `plans/mcp_sandbox.md` and remove this header.
