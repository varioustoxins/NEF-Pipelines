...
EXPECTED_CYCLES_1_WARNING = (
    "WARNING: cycles=1 is the same as cycles=0 (no Monte Carlo error analysis); "
...
def test_exponential_single_no_cycles():
